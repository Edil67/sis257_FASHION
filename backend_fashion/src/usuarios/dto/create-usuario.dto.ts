...
import { IsBooleanString, IsDefined, IsEnum, IsNotEmpty, IsString, MaxLength  } from 'class-validator';
...
export class CreateUsuarioDto {
  ...
  @MaxLength(128, { message: 'El campo password no debe ser mayor a 128 caracteres' })
